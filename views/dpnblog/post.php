...
<?php $view->style('dpnblog-highlight-css' , 'dpnblog:assets/highlight/styles/atom-one-dark.css') ?>
<?php $view->script('dpnblog-highlight-js' , 'dpnblog:assets//highlight//highlight.pack.js' , ['jquery']) ?>
        ...
        <div class="uk-margin-small">
            <ul class="uk-subnav uk-text-small">
                <?php foreach ($post->tagsSerialize() as $tag) : ?>
                    <li><a class="uk-box-shadow-small uk-box-shadow-hover-medium uk-padding-small uk-margin-small-top" href="<?= $view->url('@dpnblog/tags/id', ['id' => $tag->id]) ?>"><?= $tag->tags ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
